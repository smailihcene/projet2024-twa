			...
			<div class="container-fluid">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item">
						...
						<a class="nav-link active" href="#"><i class="bi bi-house-fill"> Acceuil </i></a>
					</li>

                    <li class="nav-item">
						<!-- mise en place dans cet élément d'un lien vers... ce qu'on veut. Ici vers la même page. -->
						<a class="nav-link active" href="#"> <i>Catégorie</i> </a>
					</li>


                    <li class="nav-item">
						<!-- mise en place dans cet élément d'un lien vers... ce qu'on veut. Ici vers la même page. -->
						<a class="nav-link active" href="#"> <i>Images</i> </a>
					</li>

					<li class="nav-item">
						<!-- mise en place dans cet élément d'un lien vers... ce qu'on veut. Ici vers la même page. -->
						<a class="nav-link active" href="http://localhost/projet2024-twa/auth.php"> <i> <u> Se déconnecter </u> </i> </a>
                    </li>
				</ul>
			</div>
		</nav>
